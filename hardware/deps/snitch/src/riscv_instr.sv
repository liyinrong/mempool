...
package riscv_instr;
  ...
  localparam logic [31:0] FCVT_D_H           = 32'b010000100010?????????????1010011;
  ...
  localparam logic [31:0] FCVT_H_Q           = 32'b010001000011?????????????1010011;
  localparam logic [31:0] FCVT_Q_H           = 32'b010001100010?????????????1010011;
  ...
  localparam logic [31:0] FCVT_S_H           = 32'b010000000010?????????????1010011;
  ...
  localparam logic [31:0] VFDOTP_AH          = 32'b1001010??????????010?????0110011;
  localparam logic [31:0] VFDOTP_R_AH        = 32'b1001010??????????110?????0110011;
  localparam logic [31:0] VFAVG_AH           = 32'b1010110??????????010?????0110011;
  localparam logic [31:0] VFAVG_R_AH         = 32'b1010110??????????110?????0110011;
  ...
  localparam logic [31:0] VFDOTP_AB          = 32'b1001010??????????011?????0110011;
  localparam logic [31:0] VFDOTP_R_AB        = 32'b1001010??????????111?????0110011;
  localparam logic [31:0] VFAVG_AB           = 32'b1010110??????????011?????0110011;
  localparam logic [31:0] VFAVG_R_AB         = 32'b1010110??????????111?????0110011;
  ...
  localparam logic [31:0] VFDOTPEXA_S_B      = 32'b1011100??????????000?????0110011;
  localparam logic [31:0] VFDOTPEXA_S_R_B    = 32'b1011100??????????100?????0110011;
  localparam logic [31:0] VFDOTPEXB_S_B      = 32'b1011110??????????000?????0110011;
  localparam logic [31:0] VFDOTPEXB_S_R_B    = 32'b1011110??????????100?????0110011;
  ...
  localparam logic [31:0] VFDOTPEXA_S_AB     = 32'b1011100??????????000?????0110011;
  localparam logic [31:0] VFDOTPEXA_S_R_AB   = 32'b1011100??????????100?????0110011;
  localparam logic [31:0] VFDOTPEXB_S_AB     = 32'b1011110??????????000?????0110011;
  localparam logic [31:0] VFDOTPEXB_S_R_AB   = 32'b1011110??????????100?????0110011;
  ...
  localparam logic [31:0] FCDOTPEX_S_H       = 32'b1001011??????????000?????1110111;
  localparam logic [31:0] FCNDOTPEX_S_H      = 32'b1001011??????????100?????1110111;
  localparam logic [31:0] FCCDOTPEX_S_H      = 32'b1011101??????????000?????1110111;
  localparam logic [31:0] FCCNDOTPEX_S_H     = 32'b1011101??????????100?????1110111;
  ...
  localparam logic [31:0] P_MAC_S            = 32'b0100001??????????010?????0110011;
  ...
  localparam logic [31:0] P_LW_RRPOST_S      = 32'b0010001??????????111?????0001011;
  localparam logic [31:0] P_LW_IRPOST_S      = 32'b?????????????????011?????0001011;
